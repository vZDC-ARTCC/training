            ...
            <div id="wizard-frame-3" class="wizard-frame" style="display:none;">
                <div class="frame-container">
                    ...
                    <div class="row frame-content">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <input type="text" id="address" class="form-control" maxlength="120" hidden/>
                            </div>
                            <div class="form-group">
                                <input type="text" id="city" class="form-control" maxlength="120" hidden/>
                            </div>
                            <div class="form-group">
                                <input type="text" id="zip-code" class="form-control" maxlength="120" hidden/>
                            </div>
                            <div class="form-group">
